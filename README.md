...
Rather than relying on magic, LikeGit implements everything from the ground up: SHA-1 hashing, object storage (blobs, trees, commits), a JSON-based staging index, branching, the Myers diff algorithm, and three-way merging.
